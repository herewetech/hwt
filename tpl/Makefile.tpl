PROJECT=###__PROJ_ORG__###::###__PROJ_NAME__###
PREFIX=$(shell pwd)
...
BINARY=###__PROJ_NAME__###
DOCKER_TAG=###__PROJ_DOCKER_TAG__###
...
svc:
	...
	@mkdir -p $(BINARY_DIR)
	@printf "    \033[1;34mTarget : \033[1;35m$(BINARY_DIR)/$(BINARY)\033[0m\n"
	@GOOS=$(OS) GOARCH=$(ARCH) CGO_ENABLED=0 $(GO) build -a -ldflags '-extldflags "-static"' -o $(BINARY_DIR)/$(BINARY) $(SOURCE_DIR)
	@echo
